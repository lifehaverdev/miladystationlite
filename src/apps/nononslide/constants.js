...
export const NONON_SLIDE_ABI = [
  ...
  {"inputs":[],"name":"SlideNotOpen","type":"error"},
  {"inputs":[],"name":"SlideNotReady","type":"error"},
  {"inputs":[],"name":"SlideNotCancellable","type":"error"},
  {"inputs":[],"name":"AlreadyJoined","type":"error"},
  {"inputs":[],"name":"MaxPlayersReached","type":"error"},
  {"inputs":[],"name":"NotAuthorized","type":"error"},
  {"inputs":[],"name":"NothingToClaim","type":"error"},
  {"inputs":[],"name":"MustOwnToken","type":"error"},
  {"inputs":[],"name":"NotEnoughValidPlayers","type":"error"},
  {"inputs":[{"internalType":"uint256","name":"tokenId","type":"uint256"},{"internalType":"uint256","name":"slideId","type":"uint256"}],"name":"TokenAlreadyCommitted","type":"error"},
  // Events
